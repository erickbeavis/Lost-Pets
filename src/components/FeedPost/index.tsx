...
export const FeedPost = () => {
  const { missingPetPost, handleRemoveSighting } = usePetsContext();
            ...
            <Card.Content>
              <View>
                ...
                <View style={{ flexDirection: 'row' }}>
                  ...
                  <List.Item
                    title="Contato"
                    description={post.user.contacts[0].content}
                    titleStyle={{ fontWeight: 'bold' }}
              ...
              <Text style={styles.petDescription}>{post.pet.description}</Text>
              ...
              <Portal>
                <Modal
                  ...
                  <ScrollView>
                    ...
                    {post.sightings.map((item: SighthingType, index: number) => {
